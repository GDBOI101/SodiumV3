...
private:
	...
	static LONG __stdcall LeoHandler(EXCEPTION_POINTERS* pExceptionInfo);
};

uintptr_t CHook::og_fun = 0;
uintptr_t CHook::hk_fun = 0;
PVOID CHook::VEH_Handle = nullptr;
DWORD CHook::oldProtection = 0;

bool CHook::Hook(uintptr_t original_fun, uintptr_t hooked_fun)
{
	CHook::og_fun = original_fun;
	CHook::hk_fun = hooked_fun;
...
LONG WINAPI CHook::LeoHandler(EXCEPTION_POINTERS* pExceptionInfo)
{
...
bool CHook::AreInSamePage(const uint8_t* Addr1, const uint8_t* Addr2)
{
